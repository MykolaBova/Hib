...
CREATE CACHED TABLE CUSTOMER(CUSTOMER_ID INTEGER NOT NULL PRIMARY KEY,FIRST_NAME VARCHAR(30) NOT NULL, LAST_NAME VARCHAR(30) NOT NULL,STREET VARCHAR(30) NOT NULL,CITY VARCHAR(30) NOT NULL, PHONE VARCHAR(30) NULL)|
CREATE CACHED TABLE PRODUCT(PRODUCT_ID INTEGER NOT NULL PRIMARY KEY, NAME VARCHAR(30) NOT NULL, PRICE DOUBLE NOT NULL, COMMENTS VARCHAR(255))|
CREATE CACHED TABLE INVOICE(INVOICE_ID INTEGER NOT NULL PRIMARY KEY, CUSTOMER_ID INTEGER NOT NULL, TOTAL DECIMAL NOT NULL, MODIFIED_ON TIMESTAMP(6) NOT NULL, CONSTRAINT SYS_FK_1 FOREIGN KEY(CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID))|
CREATE CACHED TABLE ITEM(INVOICE_ID INTEGER NOT NULL, ITEM INTEGER NOT NULL, PRODUCT_ID INTEGER NOT NULL, QUANTITY INTEGER NOT NULL, COST DECIMAL NOT NULL, CONSTRAINT SYS_PK_ITEM PRIMARY KEY(INVOICE_ID,ITEM), CONSTRAINT SYS_FK_4 FOREIGN KEY(INVOICE_ID) REFERENCES INVOICE(INVOICE_ID), CONSTRAINT SYS_FK_5 FOREIGN KEY(PRODUCT_ID) REFERENCES PRODUCT(PRODUCT_ID))|
CREATE CACHED TABLE STATES (STATE_ID VARCHAR(3) NOT NULL PRIMARY KEY, STATE_NAME VARCHAR(24) NOT NULL, STATE_CAPITOL VARCHAR(24) NOT NULL, COUNTRY VARCHAR(3) NOT NULL, REGION VARCHAR(7) NOT NULL)|
