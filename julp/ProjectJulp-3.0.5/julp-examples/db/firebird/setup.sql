EXECUTE BLOCK AS BEGIN if (not exists(select 1 from rdb$relations where rdb$relation_name = 'CUSTOMER')) then execute statement 'CREATE TABLE CUSTOMER(CUSTOMER_ID INTEGER NOT NULL PRIMARY KEY,FIRST_NAME VARCHAR(30) NOT NULL, LAST_NAME VARCHAR(30) NOT NULL,STREET VARCHAR(30) NOT NULL,CITY VARCHAR(30) NOT NULL, PHONE VARCHAR(30));'; END |
EXECUTE BLOCK AS BEGIN if (not exists(select 1 from rdb$relations where rdb$relation_name = 'PRODUCT')) then execute statement 'CREATE TABLE PRODUCT(PRODUCT_ID INTEGER NOT NULL PRIMARY KEY,NAME VARCHAR(30) NOT NULL, PRICE FLOAT NOT NULL, COMMENTS VARCHAR(255));'; END |
EXECUTE BLOCK AS BEGIN if (not exists(select 1 from rdb$relations where rdb$relation_name = 'INVOICE')) then execute statement 'CREATE TABLE INVOICE(INVOICE_ID INTEGER NOT NULL PRIMARY KEY,CUSTOMER_ID INTEGER NOT NULL,TOTAL DECIMAL NOT NULL,MODIFIED_ON TIMESTAMP NOT NULL,CONSTRAINT SYS_FK_1 FOREIGN KEY(CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID));'; END |
EXECUTE BLOCK AS BEGIN if (not exists(select 1 from rdb$relations where rdb$relation_name = 'ITEM')) then execute statement 'CREATE TABLE ITEM(INVOICE_ID INTEGER NOT NULL,ITEM INTEGER NOT NULL,PRODUCT_ID INTEGER NOT NULL,QUANTITY INTEGER NOT NULL,COST DECIMAL NOT NULL,CONSTRAINT SYS_PK_ITEM PRIMARY KEY(INVOICE_ID,ITEM),CONSTRAINT SYS_FK_4 FOREIGN KEY(INVOICE_ID) REFERENCES INVOICE(INVOICE_ID),CONSTRAINT SYS_FK_5 FOREIGN KEY(PRODUCT_ID) REFERENCES PRODUCT(PRODUCT_ID));'; END |
EXECUTE BLOCK AS BEGIN if (not exists(select 1 from rdb$relations where rdb$relation_name = 'STATES')) then execute statement 'CREATE TABLE STATES (STATE_ID VARCHAR(3) NOT NULL PRIMARY KEY,STATE_NAME VARCHAR(24) NOT NULL,STATE_CAPITOL VARCHAR(24) NOT NULL,COUNTRY VARCHAR(3) NOT NULL,REGION VARCHAR(7) NOT NULL)'; END |
DELETE FROM ITEM |
DELETE FROM PRODUCT |
DELETE FROM INVOICE |
...
INSERT INTO INVOICE VALUES(0,0,2607.60,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(1,4,1610.70,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(2,4,3789.00,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(3,4,5974.50,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(4,4,1953.00,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(5,4,4182.90,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(6,4,3340.20,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(7,26,5328.60,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(8,29,2675.10,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(9,38,6982.20,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(10,24,3274.50,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(11,24,2532.30,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(12,23,4578.30,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(13,39,7001.70,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(14,35,4940.40,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(15,39,1027.80,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(16,45,3657.30,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(17,46,3776.40,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(18,4,3772.80,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(19,9,804.30,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(20,19,3139.20,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(21,8,3740.10,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(22,40,2289.90,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(23,36,5166.60,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(24,15,4344.30,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(25,31,2054.10,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(26,27,4972.80,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(27,24,583.50,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(28,35,1664.40,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(29,46,2515.50,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(30,13,2117.40,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(31,22,2715.90,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(32,20,1098.60,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(33,40,4300.20,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(34,33,4290.60,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(35,4,3102.60,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(36,42,3200.10,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(37,39,7331.10,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(38,46,6373.80,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(39,5,1311.60,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(40,4,5288.40,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(41,19,5475.60,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(42,38,1436.40,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(43,13,4827.60,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(44,32,3388.20,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(45,42,4731.00,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(46,24,5827.20,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(47,45,2320.80,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(48,22,3494.70,'2008-08-08 20:08:08')|
INSERT INTO INVOICE VALUES(49,32,4944.30,'2008-08-08 20:08:08')|
